...
class lr_polynomial_decay:
    def __init__(self, epochs, initial_learning_rate, warmup_epoch, power=1.0):
        self.epochs = epochs
...
class lr_exponential_decay:
    def __init__(self, epochs, initial_learning_rate, warmup_epoch):
        self.epochs = epochs
        self.initial_learning_rate = initial_learning_rate
        self.warmup_epoch = warmup_epoch
